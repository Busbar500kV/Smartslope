"""
Minimal synthetic data generator entrypoint for Smartslope.

This module implements a compact simulate() + CLI that mirrors the existing
coherent-phase model found in the repository (motion models, drift, noise,
dropouts, unwrap). It writes a .npz to data/synthetic/kegalle_demo_run.npz by default.
"""
...
def repo_root() -> Path:
    # smartslope/ -> repo root is one level up
